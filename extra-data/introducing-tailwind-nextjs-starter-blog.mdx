---
title: 'Introducing Tailwind Nextjs Starter Note'
date: '2021-01-12'
lastmod: '2021-12-22'
...
1. JS (official support) - `npx degit https://github.com/adityacodes/ulclawnotes.git` or TS (community support) - `npx degit adityacodes/ulclawnotes#typescript`
...
Using the template? Support this effort by giving a star on GitHub, sharing your own note and giving a shoutout on Twitter or be a project [sponsor](https://github.com/sponsors/adityacodes).
