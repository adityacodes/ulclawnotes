...
A demo of a multiple authors post is shown in [Introducing Tailwind Nextjs Starter Blog post](/blog/introducing-ulclawnotes).
...
You can see an example of such a migration in this [commit](https://github.com/adityacodes/adityacodes.com/commit/bba1c185384fd6d5cdaac15abf802fdcff027286) for my personal blog.
