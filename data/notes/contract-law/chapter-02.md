...
**Such cases are an invitation to make an offer (to treat)**, eg. A invites persons to an auction. This is an invitation to treat. Bids made by the persons in the auction are an offer. Offer is accepted only by the fall of the hammer 🔨. Similarly a bidder can withdraw his bid (offer) before the fall of the hammer. An auctioner can even cancel the sale announced by him.
