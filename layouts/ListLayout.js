...
export default function ListLayout({ posts, title, initialDisplayPosts = [], pagination }) {
  ...
  const filteredNotePosts = posts.filter((frontMatter) => {
  ...
  const displayPosts =
    initialDisplayPosts.length > 0 && !searchValue ? initialDisplayPosts : filteredNotePosts
  ...
  return (
    <>
      <div className="divide-y">
        ...
        <ul>
          {!filteredNotePosts.length && 'No posts found.'}
